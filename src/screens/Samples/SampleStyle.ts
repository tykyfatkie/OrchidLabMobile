...
export const STATUS_FILTERS = [
  ...
  { key: 'InProgressed',           label: 'Đang tiến hành',    color: COLORS.blue },
  { key: 'ConvertedToSeedling',    label: 'Đã chuyển cây',     color: COLORS.green },
  { key: 'ExecutedBecauseOfDisease', label: 'Hủy do bệnh',    color: COLORS.red },
  { key: 'Cancelled',              label: 'Đã hủy',            color: COLORS.amber },
];
...
export const METRIC_CARDS = {
  ...
  converted:   { bg: COLORS.greenBg, iconColor: COLORS.green,   textColor: COLORS.green },
  cancelled:   { bg: COLORS.redBg,   iconColor: COLORS.red,     textColor: COLORS.red },
};
