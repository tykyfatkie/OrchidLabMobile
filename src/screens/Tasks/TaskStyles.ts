...
export const STATUS_FILTERS = [
  ...
  { key: 'Template',   label: 'Mẫu',          color: COLORS.filterGray },
  { key: 'Todo',       label: 'Cần làm',      color: COLORS.blue },
  { key: 'InProgress', label: 'Đang làm',     color: COLORS.amber },
  { key: 'Done',       label: 'Hoàn thành',   color: COLORS.green },
  { key: 'Cancelled',  label: 'Đã hủy',       color: COLORS.red },
];
